...
class N2KCommands {
  ...
  setWindAngle(angle) {
    ...
    this.app.debug('Sending wind angle command: ' + angleDeg.toFixed(1) + '°')
  ...
  tack(direction) {
    this.app.debug('Sending tack command: ' + direction)
  ...
  gybe(direction) {
    this.app.debug('Sending gybe command: ' + direction)
